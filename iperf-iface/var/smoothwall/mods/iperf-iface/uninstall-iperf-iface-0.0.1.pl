...
#
# uninstall script for [3.1] Iperf Interface v0.0.1
# MOD Author: dataking
...
if (&installed ("/usr/lib/smoothwall/langs/en.pl", "# Iperf Interface v0.0.1")) {
	print "\nUninstalling Iperf Interface v0.0.1\n \n";
}
else
{
	print " \nCan not find Iperf Interface v0.0.1!\n \n";
	exit;
}
...
$dir = '/httpd/cgi-bin/';
&uninstallrestore ('iptools.cgi' ,$dir, $bkp);

$dir = '/httpd/html/help';
&uninstallrestore ('iptools.cgi.html.en', $dir, $bkp);
...
&easymod ("/usr/lib/smoothwall/langs/en.pl", "$param/en.pl.1.d",'8',"/dev/null");
