...
#
# uninstall script for [3.0] Enhanced Firewall Logs MOD V1.4
...
if (&installed ("/usr/lib/smoothwall/langs/base.pl", "# Enhanced Firewall Logs MOD V1.4")) {
	print "\nUninstalling Enhanced Firewall Logs MOD V1.4\n \n";
}
else
{
	        print " \nCan not find Enhanced Firewall Logs MOD V1.4!\n \n";
	        exit;
			}
...
&easymod ("/usr/lib/smoothwall/langs/base.pl", "$param/base.pl.94.d",'7',"/dev/null");
