...
#
# uninstall script for [3.0] Enhanced Firewall Logs MOD V1.4.3
...
if (&installed ("/usr/lib/smoothwall/langs/base.pl", "# Enhanced Firewall Logs MOD V1.4.3")) {
	print "\nUninstalling Enhanced Firewall Logs MOD V1.4.3\n \n";
}
else
{
	        print " \nCan not find Enhanced Firewall Logs MOD V1.4.3!\n \n";
	        exit;
			}
...
&easymod ("/usr/lib/smoothwall/langs/base.pl", "$param/base.pl.97.d",'11',"/dev/null");
