...
#
# uninstall script for [3.0] Enhanced Firewall Logs MOD V1.4.1
...
if (&installed ("/usr/lib/smoothwall/langs/base.pl", "# Enhanced Firewall Logs MOD V1.4.1")) {
	print "\nUninstalling Enhanced Firewall Logs MOD V1.4.1\n \n";
}
else
{
	        print " \nCan not find Enhanced Firewall Logs MOD V1.4.1!\n \n";
	        exit;
			}
...
&easymod ("/usr/lib/smoothwall/langs/base.pl", "$param/base.pl.95.d",'7',"/dev/null");
