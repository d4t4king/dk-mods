...
#
# install script for [3.0] Enhanced Firewall Logs MOD V1.4.3
...
if (&installed ("/usr/lib/smoothwall/langs/base.pl", "# Enhanced Firewall Logs MOD V1.0")) {
...
if (&installed ("/usr/lib/smoothwall/langs/base.pl", "# Enhanced Firewall Logs MOD V1.1")) {
...
if (&installed ("/usr/lib/smoothwall/langs/base.pl", "# Enhanced Firewall Logs MOD V1.2")) {
...
if (&installed ("/usr/lib/smoothwall/langs/base.pl", "# Enhanced Firewall Logs MOD V1.4")) {
...
if (&installed ("/usr/lib/smoothwall/langs/base.pl", "# Enhanced Firewall Logs MOD V1.4.1")) {
...
if (&installed ("/usr/lib/smoothwall/langs/base.pl", "# Enhanced Firewall Logs MOD V1.4.2")) {
...
if (&installed ("/usr/lib/smoothwall/langs/base.pl", "# Enhanced Firewall Logs MOD V1.4.3")) {
	print " \nEnhanced Firewall Logs MOD V1.4.3 already found!\n \n";
	exit;
}

print "Installing Enhanced Firewall Logs V1.4.3...\n";
...
# Install CIDR.pm
$dir = '/usr/lib/perl5/site_perl/5.8.8/Net';
&install ('CIDR.pm', $dir, $mod);

# Backup base (in case)
$dir = '/usr/lib/smoothwall/langs';
&backup ('base.pl', $dir, $bkp, $mod);
...
&easymod ("/usr/lib/smoothwall/langs/base.pl", "$param/base.pl.8.s",'0',"$param/base.pl.8.r");
