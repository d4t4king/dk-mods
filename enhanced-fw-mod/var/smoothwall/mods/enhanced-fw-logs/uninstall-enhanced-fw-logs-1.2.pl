...
#
# uninstall script for [3.0] Enhanced Firewall Logs MOD V1.0
...
if (&installed ("/usr/lib/smoothwall/langs/base.pl", "# Enhanced Firewall Logs MOD V1.2")) {
	print "\nUninstalling Enhanced Firewall Logs MOD V1.2\n \n";
}
else
{
	        print " \nCan not find Enhanced Firewall Logs MOD V1.2!\n \n";
	        exit;
			}
...
&easymod ("/usr/lib/smoothwall/langs/base.pl", "$param/base.pl.92.d",'7',"/dev/null");
