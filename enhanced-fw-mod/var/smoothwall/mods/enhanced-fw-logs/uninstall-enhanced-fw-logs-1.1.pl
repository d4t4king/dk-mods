...
if (&installed ("/usr/lib/smoothwall/langs/base.pl", "# Enhanced Firewall Logs MOD V1.1")) {
	print "\nUninstalling Enhanced Firewall Logs MOD V1.1\n \n";
}
else
{
	        print " \nCan not find Enhanced Firewall Logs MOD V1.1!\n \n";
	        exit;
			}
...
&easymod ("/usr/lib/smoothwall/langs/base.pl", "$param/base.pl.91.d",'7',"/dev/null");
